...
@WebServlet("/MbrReg")
public class MbrRegCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("Member Registration  doGet Starts");
		...
		if (button.equalsIgnoreCase("Back")) {
			...
			boolean status = LibraryInfoDao.insertMember(mmbrRegDto);
			if(status) {
				out.println("<h1 style='color:green;margin-top:100px;'>Hi  "+memberName+" , you are registered successfully</h1>");
